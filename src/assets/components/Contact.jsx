...
const Contact = () => {
  return (
    <div name="contacto" className="w-full h-screen p-4 bg-gradient-to-b from-neutral-300 to-cyan-100 text-cyan-900 dark:bg-gradient-to-b dark:from-black dark:to-gray-800 dark:text-white">
